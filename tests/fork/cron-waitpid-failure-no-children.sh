...
run_test -q -C "$DTEE_TEST_MONITOR_OUTPUT" ./util/test-lorem-ipsum-wait-exit 0
RET=$?

test_prepare
eval_ret run_with_preload ./util/test-waitpid ./dtee ./dtee -q -C "$DTEE_TEST_MONITOR_OUTPUT" ./util/test-lorem-ipsum-wait-exit 0
RET2=$?
