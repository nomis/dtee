...
// Boost (1.62) is going to consume "--=argument" as a positional argument
// whether we want it to or not. It will also insist on accepting a long name
// for positional arguments. To avoid accepting hidden names like "--command",
// just explicitly use "--" as the name.
